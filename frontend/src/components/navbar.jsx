...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full bg-black bg-opacity-40 backdrop-blur-0 text-white pb-2 pl-2 z-20">
      {isPhone ? (
        ...
        <div className="flex items-center justify-between p-4">
          ...
          <nav className="pt-5">
            <ul className="flex space-x-8 text-lg text-slate-300 gap-8">
              <li>
